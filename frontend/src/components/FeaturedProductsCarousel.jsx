...
const CustomFeaturedCard = ({ product }) => {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div style={cardStyles.hoverOverlay} onClick={handleAddToCart}>
          <div style={cardStyles.addToCartIcon}><AddToCartIcon /></div>
        </div>
      )}
    </div>
  );
...
const FeaturedProductsCarousel = ({ products, title }) => {
